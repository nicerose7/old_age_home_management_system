...
const AppointmentSchema = new mongoose.Schema({
  ...
  // Family appointment specific fields
  relativeName: {
    type: String,
    trim: true,
    required: function() {
  ...
  relativeNumber: {
    ...
    validate: {
      validator: function(v) {
        // Basic phone number validation - optional for family appointments
        if (!v) return true;
...
// Virtual for days left until appointment
...
// Pre-save hook to validate type-specific fields
...
// Static method to get upcoming appointments with enhanced data
...
// Static method to search appointments with enhanced results
...
// Instance method to mark as completed with validation
...
// Query helper for filtering by upcoming dates
...
// Query helper for filtering by appointment type
