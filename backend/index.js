...
// Add Resident (with file uploads)
...
// Update Resident (file + data update)
...
// Delete Resident (with cleanup of related activities)
app.delete('/residents/:id', authenticate, async (req, res) => {
  try {
    ...
    // Delete related activity entries
...
// Get Monthly Summary of Participation
...
app.post('/appointments', authenticate, async (req, res) => {
  try {
    ...
    // Return the saved appointment with populated resident data
...
// Get Upcoming Appointments (fixed with proper date handling)
app.get('/appointments/upcoming', authenticate, async (req, res) => {
  try {
    ...
    // Enhanced response with notification-friendly data
...
app.get('/appointments/search/:query', authenticate, async (req, res) => {
  try {
    ...
    // Filter out appointments without resident if the search didn't match resident name
