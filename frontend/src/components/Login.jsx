...
import AccessibilityNewIcon from '@mui/icons-material/AccessibilityNew'; // Caring for elderly symbol
    ...
    const loginHandler = () => {
        axios.post('http://localhost:3000/login', input)
            .then((res) => {
                ...
                setIsLoggedIn(true);
                navigate('/residents'); // redirect after login
            })
            .catch((err) => {
        ...
        >
            <Paper elevation={3} sx={{
                ...
                <Button
                    ...
                    fullWidth
                    sx={{ mt: 3, backgroundColor: '#3F51B5', '&:hover': { backgroundColor: '#303F9F' } }} // Primary color
                >
                    Login
                </Button>
